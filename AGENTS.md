...
| --- | --- | --- |
| [docs/development.md](docs/development.md) | **Required gate**: `wails dev` browser-first 개발·검증 절차, large repository load budget, 개발용 project 등록 | Product code 또는 test를 변경하는 모든 작업의 시작과 완료 전 |
...
| [docs/vscode.md](docs/vscode.md) | VS Code extension 기능, helper protocol, 지원 target과 배포 경계 | IDE surface, helper contract 또는 VSIX 지원 범위가 바뀔 때 |
